  ...
  return (
    <header className="app-header">
      <div className="app-container app-header-inner">
        ...
        <nav aria-label="Primary"><Link href="/properties">Properties</Link><Link href="/services">Services</Link><Link href="/blog">Guides</Link><Link href="/about">About</Link></nav>
